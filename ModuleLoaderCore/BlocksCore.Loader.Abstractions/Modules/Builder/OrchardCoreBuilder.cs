...
namespace BlocksCore.Loader.Abstractions.Modules.Builder
{
    public class BlocksCoreBuilder
    {
        ...
        public BlocksCoreBuilder RegisterStartup<T>() where T : class, IStartup
        {
        ...
        public BlocksCoreBuilder ConfigureServices(Action<IServiceCollection, IServiceProvider> configure, int order = 0)
        {
        ...
        /// <param name="configure">The action to execute when configuring the services for a tenant.</param>
        /// <param name="order">The order of the action to execute. Lower values will be executed first.</param>
        public BlocksCoreBuilder ConfigureServices(Action<IServiceCollection> configure, int order = 0)
        {
        ...
        /// <param name="configure">The action to execute when configuring the request's pipeling for a tenant.</param>
        /// <param name="order">The order of the action to execute. Lower values will be executed first.</param>
        public BlocksCoreBuilder Configure(Action<IApplicationBuilder, IRouteBuilder> configure, int order = 0)
        {
        ...
        /// <param name="configure">The action to execute when configuring the request's pipeling for a tenant.</param>
        /// <param name="order">The order of the action to execute. Lower values will be executed first.</param>
        public BlocksCoreBuilder Configure(Action<IApplicationBuilder> configure, int order = 0)
        {
