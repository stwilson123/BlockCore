...
using BlocksCore.Loader.Abstractions.Modules.Services;
...
using BlocksCore.Loader.Extensions;
using BlocksCore.Loader.Modules.Services;
...
namespace BlocksCore.Loader.Modules.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void AddDefaultServices(IServiceCollection services)
        {
            ...
            // These services might be moved at a higher level if no components from BlocksCore needs them.
            services.AddLocalization();
            services.AddWebEncoders();

            // ModularTenantRouterMiddleware which is configured with UseBlocksCore() calls UseRouter() which requires the routing services to be
